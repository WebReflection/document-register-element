  ...
  'x-direct',
  {
    prototype: Object.create(
      ...
      createdCallback: {value: function() {
        console.log('created: ' + this.nodeName);
      }},
      attachedCallback: {value: function() {
        console.log('attached: ' + this.nodeName);
      }},
      detachedCallback: {value: function() {
        console.log('detached: ' + this.nodeName);
      }}
    })
  }
);
...
document.body.appendChild(document.createElement('x-direct'));
document.body.appendChild(document.createElement('div', 'x-indirect'));



var div = document.createElement('div');
div.appendChild(document.createElement('x-direct'));
document.body.appendChild(div);
document.body.appendChild(div.cloneNode(true));

var div = document.createElement('div');
div.appendChild(document.createElement('div', 'x-indirect'));
document.body.appendChild(div);
document.body.appendChild(div.cloneNode(true));


document.body.innerHTML = '<div><x-direct><div is="x-indirect"></div></x-direct></div>';
